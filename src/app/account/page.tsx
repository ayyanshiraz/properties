...
export default function AccountDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-20 lg:w-64 bg-white border-r border-gray-200 flex flex-col hidden md:flex sticky top-0 h-screen shrink-0 z-10">
        <div className="h-16 flex items-center justify-center lg:justify-start lg:px-6 border-b border-gray-200 shrink-0">
        ...
        <nav className="flex-1 py-4 flex flex-col gap-2 px-3 overflow-y-auto">
          ...
          <button onClick={handleLogout} className="flex items-center gap-3 px-3 py-3 text-red-500 hover:bg-red-50 hover:text-red-600 rounded-lg cursor-pointer transition-colors w-full text-left mt-auto shrink-0">
