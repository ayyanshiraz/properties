...
export default async function BuyDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!propertyData) {
    propertyData = { id: routeId, title: `Property Not Found`, location: `Unknown`, priceStr: `N/A`, area: `N/A`, image: `/buy/1.webp`, images: [`/buy/1.webp`], description: `This property is no longer available.`, propertyType: `Unknown`, propertyStatus: `Sold / Unavailable`, propertyId: `N/A`, agentName: `Qemaat Agent` };
  }
