...
export default async function HomesDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!propertyData) {
    propertyData = { id: routeId, title: `Property Not Found`, location: `Unknown`, priceStr: `N/A`, area: `N/A`, image: `/buy/9.webp`, images: [`/buy/9.webp`], description: `This property is no longer available.`, propertyType: `Unknown`, propertyStatus: `Unavailable`, propertyId: `N/A` };
  }
